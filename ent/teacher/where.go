...
// TID applies equality check predicate on the "t_id" field. It's identical to TIDEQ.
func TID(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldEQ(FieldTID, v))
}
...
// TIDEQ applies the EQ predicate on the "t_id" field.
func TIDEQ(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldEQ(FieldTID, v))
}

// TIDNEQ applies the NEQ predicate on the "t_id" field.
func TIDNEQ(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldNEQ(FieldTID, v))
}

// TIDIn applies the In predicate on the "t_id" field.
func TIDIn(vs ...int) predicate.Teacher {
	return predicate.Teacher(sql.FieldIn(FieldTID, vs...))
}

// TIDNotIn applies the NotIn predicate on the "t_id" field.
func TIDNotIn(vs ...int) predicate.Teacher {
	return predicate.Teacher(sql.FieldNotIn(FieldTID, vs...))
}

// TIDGT applies the GT predicate on the "t_id" field.
func TIDGT(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldGT(FieldTID, v))
}

// TIDGTE applies the GTE predicate on the "t_id" field.
func TIDGTE(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldGTE(FieldTID, v))
}

// TIDLT applies the LT predicate on the "t_id" field.
func TIDLT(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldLT(FieldTID, v))
}

// TIDLTE applies the LTE predicate on the "t_id" field.
func TIDLTE(v int) predicate.Teacher {
	return predicate.Teacher(sql.FieldLTE(FieldTID, v))
}
